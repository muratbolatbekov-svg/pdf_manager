...
urlpatterns = [
    ...
    path('settings/api/create/', views.api_key_create, name='api_key_create'),
    path('settings/api/<int:key_id>/delete/', views.api_key_delete, name='api_key_delete'),
    ...
    path('settings/users/<int:user_id>/rename/', views.user_rename, name='user_rename'),
